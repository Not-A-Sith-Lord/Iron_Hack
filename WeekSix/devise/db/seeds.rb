...
rick = User.create!(first_name: "Tony", last_name: "Stark", email: "tony@sexy.com", password: "whatever", password_confirmation: "whatever")
tony = User.create!(first_name: "Rick", last_name: "Sanchez", email: "ricky@rick.com", password: "whatever", password_confirmation: "whatever")
...
rick.comics.create!(title: "V for Vendetta", publisher: "Vetigo")
